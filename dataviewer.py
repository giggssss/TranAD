...
data = np.load('/workspace/data/github/TranAD/processed/Gyeongsan/train.npy', allow_pickle=True)
...
data = np.load('/workspace/data/github/TranAD/processed/Gyeongsan/test.npy', allow_pickle=True)
num_columns = data.shape[1]
